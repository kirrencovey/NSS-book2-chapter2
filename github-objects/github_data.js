...
// **************************************************** //
// *****  Print commit message with known index: 


// const idToFind = "8030403992";

// for (let i = 0; i < githubData.length; i++) {
//         let idLocator = githubData[i];
//         if (idLocator.id === idToFind) {
//                 console.log(idLocator.payload.commits[0].message);
//             }
//         }
       

// **************************************************** //
// *****  Print all messages for the commit:     
              

// const idToFind = "8032498553";

// for (let i = 0; i < githubData.length; i++) {
//     let idLocator = githubData[i];
//     if (idLocator.id === idToFind) {
//         let commitsArray = idLocator.payload.commits;
//         for (let i = 0; i < commitsArray.length; i++) {
//             let currentCommit = commitsArray[i];
//             console.log(currentCommit.message);
//         }
//     }
// }
...
// **************************************************** //
// *****  Turned into a reusable function:      
...
printMessages("8032498553");
printMessages("8030403992");
printMessages("8033299496");
printMessages("8022629534");
